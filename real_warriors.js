...
class Clovis extends Warrior{
    constructor(level){
        super(["Clovis", [0.8, 0.3, 0.91, 1, 2], water, new Healing(), new Lead(-15, "w")], level);
    }
}
...
class Brutus extends Warrior{
    constructor(level){
        super(["Brutus", [0.9334, 0.1, 0.8, 2, 2], fire, new Soul_steal(), new Lead(-15, "f")], level);
    }
}
...
var starter = new Team([new Abu(5), new Zenghis(5), new Toki(5)], "Starter Team");
var abu1 = new Team([new Brutus(5), new Osgood(5), new Crixus(5)], "ABU");
